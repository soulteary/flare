...
func RegisterRouting(e *echo.Echo) {
	...
	e.GET(FlareDefine.MiscPages.RedirHome.Path, func(c *echo.Context) error {
		return c.Redirect(http.StatusFound, FlareDefine.RegularPages.Home.Path)
	})

	e.GET(FlareDefine.MiscPages.RedirHelper.Path, func(c *echo.Context) error {
